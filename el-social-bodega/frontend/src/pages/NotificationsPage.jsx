...
import { FiBell, FiAlertTriangle, FiShoppingCart, FiTrendingUp, FiInfo } from 'react-icons/fi'
...
const NOTIFICATION_TYPES = {
  ...
  price_increase: { icon: FiTrendingUp, color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-500' },
                ...
                <div className="flex items-start gap-4">
                  ...
                  {isUnread && (
                    <button
                      ...
                      className="flex-shrink-0 px-3 py-1.5 text-sm font-medium text-primary hover:bg-primary/10 rounded-lg transition-colors"
                    >
